...
class FetchAllCustomersForTheGivenClientId extends Request
{
	 ...
	 * @param null|bool $syncItem Fetch all customers for the given client ID and return them as syncItems
	 * @param null|bool $isActive Fetch all active customers. If omitted, all customers are returned.
	 */
